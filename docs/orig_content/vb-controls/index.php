...
<p>The choices presented to the user come from a range of cells somewhere on your spreadsheet. You assign the set of choices to the combobox by setting the <strong>ListFillRange</strong> property of the combo box. The range is referenced like you would in a spreadsheet (J2:J5, Sheet2!G4:G6, etc.). The <strong>LinkedCell</strong> property allows the user to output a value from their selection to a specific cell. LinkedCell outputs this value from a column in the ListFillRange and this column is denoted by the <strong>BoundColumn</strong> property.</p>
...
<table width="777" border="1">
  <tbody>
    ...
    <tr>
      <td> <strong>Christmas Tree -</strong> Use shapes, controls, and macros in this fun visually basic controlled workbook to decorate a Christmas Tree.</td>
      <td align="center" valign="top">Easy</td>
      <td align="center" valign="top"><a href="christmas_tree.xlsm">christmas_tree.xlsm</a></td>
      <td align="center" valign="top"><a href="christmas_tree_key.xlsm">christmas_tree_key.xlsm</a></td>
    </tr>
    <tr>
      <td><strong>Control Exercises - </strong>Learn how to use all of the basic Excel controls with these short and simple exercises. </td>
      <td align="center" valign="top">Medium</td>
      <td align="center" valign="top"><a href="control_exercises.xlsm">control_exercises.xlsm</a></td>
      <td align="center" valign="top"><a href="control_exercises_key.xlsm">control_exercises_key.xlsm</a></td>
    </tr>
    <tr>
      <td><strong>Madlib Controls -</strong> Use controls to create a madlib generator for you and your friends.</td>
      <td align="center" valign="top">Hard</td>
      <td align="center" valign="top"><a href="madlib_controls.xlsm">madlib_controls.xlsm</a></td>
      <td align="center" valign="top"><a href="madlib_controls_key.xlsm">madlib_controls_key.xlsm</a></td>
    </tr>
  </tbody>
</table>
<br />
